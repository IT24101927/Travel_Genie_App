...
const AddExpenseScreen = ({ navigation, route }) => {
  ...
  const preselectedTripTitle = route.params?.tripTitle || '';
  ...
  // If no tripId is provided, we can't save. Display an error immediately.
  useEffect(() => {
          ...
          <View style={styles.header}>
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              {preselectedTripTitle ? (
                <Text style={styles.headerSub} numberOfLines={1}>{preselectedTripTitle}</Text>
              ) : null}
            </View>
            <View style={{ width: 36 }} />
          </View>
